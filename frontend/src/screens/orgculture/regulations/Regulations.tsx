            ...
            <table className="board_list">
              ...
              <tbody>
                <tr className="board_content">
                  <td style={{color: '#D56D6D'}}>1</td>
                  <td style={{textAlign: 'left', paddingLeft: '20px'}}><Link to={"/detailRegulation"}>취업 규칙</Link></td>
                  <td>2099-99-99</td>
                </tr>
                <tr className="board_content">
                  <td style={{color: '#D56D6D'}}>2</td>
                  <td style={{textAlign: 'left', paddingLeft: '20px'}}>취업 규칙</td>
                  <td>2099-99-99</td>
                </tr>
                <tr className="board_content">
                  <td style={{color: '#D56D6D'}}>3</td>
                  <td style={{textAlign: 'left', paddingLeft: '20px'}}>취업 규칙</td>
                  <td>2099-99-99</td>
                </tr>
                <tr className="board_content">
                  <td style={{color: '#D56D6D'}}>4</td>
                  <td style={{textAlign: 'left', paddingLeft: '20px'}}>취업 규칙</td>
                  <td>2099-99-99</td>
                </tr>
                <tr className="board_content">
                  <td style={{color: '#D56D6D'}}>5</td>
                  <td style={{textAlign: 'left', paddingLeft: '20px'}}>취업 규칙</td>
                  <td>2099-99-99</td>
                </tr>
                <tr className="board_content">
                  <td style={{color: '#D56D6D'}}>6</td>
                  <td style={{textAlign: 'left', paddingLeft: '20px'}}>취업 규칙</td>
                  <td>2099-99-99</td>
                </tr>
                <tr className="board_content">
                  <td style={{color: '#D56D6D'}}>7</td>
                  <td style={{textAlign: 'left', paddingLeft: '20px'}}>취업 규칙</td>
                  <td>2099-99-99</td>
                </tr>
                <tr className="board_content">
                  <td style={{color: '#D56D6D'}}>8</td>
                  <td style={{textAlign: 'left', paddingLeft: '20px'}}>취업 규칙</td>
                  <td>2099-99-99</td>
                </tr>
                <tr className="board_content">
                  <td style={{color: '#D56D6D'}}>9</td>
                  <td style={{textAlign: 'left', paddingLeft: '20px'}}>취업 규칙</td>
                  <td>2099-99-99</td>
                </tr>
                <tr className="board_content" style={{borderBottom: '2px solid #DCDCDC'}}>
                  <td style={{color: '#D56D6D'}}>10</td>
                  <td style={{textAlign: 'left', paddingLeft: '20px'}}>취업 규칙</td>
                  <td>2099-99-99</td>
                </tr>
              </tbody>
